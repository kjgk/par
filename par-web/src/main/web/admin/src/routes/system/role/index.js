...
const Component = ({
  ...
  const {
    ...
    menuModalVisible, checkedMenus, menuData,
  } = model
  ...
  const menuModalProps = {
    ...
    maskClosable: false,
    modalLoading: loading.effects[`${namespace}/showMenuModal`],
    confirmLoading: loading.effects[`${namespace}/saveMenu`],
    title: `分配菜单`,
    onCheck (checkedMenus, {halfCheckedKeys}) {
      dispatch({
        type: `${namespace}/checkedMenu`,
        payload: {checkedMenus, halfCheckedMenus: halfCheckedKeys},
      })
    },
    onOk () {
      dispatch({
        type: `${namespace}/saveMenu`,
      })
    },
    onCancel () {
      dispatch({
        type: `${namespace}/hideMenuModal`,
      })
    },
  }
